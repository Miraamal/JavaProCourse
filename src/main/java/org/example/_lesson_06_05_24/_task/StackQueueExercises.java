package org.example._lesson_06_05_24._task;
...
public class StackQueueExercises {
    ...
    public static boolean isBalanced(String expression) {
        ...
        for (char c : expression.toCharArray()) {
            if (c == '{' || c =='[' || c =='(')stack.add(c);
               ...
               if (last == null || !isRespond(last,c)) return false;
            }
    ...
    private static boolean isRespond(char open, char close){
        return open == '{' && close == '}' ||
                open == '[' && close == ']' ||
                open == '(' && close == ')';
    }
